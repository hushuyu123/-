...
public class AdminSet extends BaseTest{
	...
	public void demo1() throws IOException, InterruptedException {
		...
		webtest.typeAndClear("id=admin_password", getExcel(24, 1));
		webtest.typeAndClear("id=admin_password_con", getExcel(24, 2));
	...
	public void demo2() throws IOException, InterruptedException {
		...
		Thread.sleep(2000);
		webtest.click("xpath=//td[contains(text(),'admin')]/../td[6]/a");
		webtest.typeAndClear("id=admin_password", getExcel(25, 1));
		webtest.typeAndClear("id=admin_password_con", getExcel(25, 2));
		webtest.click("xpath=//button[@type='submit']");
	...
	public void demo3() throws IOException, InterruptedException {
		...
		Thread.sleep(2000);
		webtest.click("xpath=//td[contains(text(),'admin')]/../td[6]/a");
		webtest.typeAndClear("id=admin_password", getExcel(26, 1));
		webtest.typeAndClear("id=admin_password_con", getExcel(26, 2));
		webtest.click("xpath=//button[@type='submit']");
