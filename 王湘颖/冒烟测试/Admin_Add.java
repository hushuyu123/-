...
public class Admin_Add extends BaseTest{
	@BeforeClass
	public void admin() {
    ...
    public Object[][] data1() throws IOException{
    	return ExcelDataProvider.getTestDataByExcel("E:\\ATestObject\\data\\da.xlsx","addgoods");
    }
	@DataProvider(name="testData7")
    public Object[][] data4() throws IOException{
    	return ExcelDataProvider.getTestDataByExcel("E:\\ATestObject\\data\\da.xlsx","addgoodsort");
    }
	@DataProvider(name="testData8")
    public Object[][] data5() throws IOException{
    	return ExcelDataProvider.getTestDataByExcel("E:\\ATestObject\\data\\da.xlsx","addgoodsort2");
    }
	@DataProvider(name="testData9")
    public Object[][] data6() throws IOException{
    	return ExcelDataProvider.getTestDataByExcel("E:\\ATestObject\\data\\da.xlsx","test24");
    }
    ...
    public Object[][] data11() throws IOException{
    	return ExcelDataProvider.getTestDataByExcel("E:\\ATestObject\\data\\da.xlsx","test42");
    }
	@DataProvider(name="testData16")
    public Object[][] data13() throws IOException{
		return ExcelDataProvider.getTestDataByExcel("E:\\ATestObject\\data\\da.xlsx","goodsmes");
	}
	//13，商品分类中添加商品
