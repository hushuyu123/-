...
public class BaseTest {
	...
	public String driverType = "firefox";;
	...
	public String getExcel1(int i, int j) throws IOException {
		Object[][] result = excel.getTestDataByExcel("E:\\shixun\\excel\\DB.xlsx", "Sheet1");
		return (String) result[i][j];
	}
	
	public String getExcel2(int i, int j) throws IOException {
		Object[][] result = excel.getTestDataByExcel("E:\\shixun\\excel\\DBShop2.xlsx", "Sheet1");
		return (String) result[i][j];
	}
