...
public class Admin_OperationManagement extends BaseTest {
	...
	public Object[][] word() throws IOException {
		...
		return excel.getTestDataByExcel("E:\\shixun\\excel\\AddData2.xls", "Sheet1");
	}
	...
	public Object[][] word1() throws IOException {
		ExcelDataProvider excel = new ExcelDataProvider();
		return excel.getTestDataByExcel("E:\\shixun\\excel\\AddData2.xls", "Sheet2");
	}
	...
	public Object[][] word2() throws IOException {
		ExcelDataProvider excel = new ExcelDataProvider();
		return excel.getTestDataByExcel("E:\\shixun\\excel\\AddData2.xls", "Sheet3");
	}
